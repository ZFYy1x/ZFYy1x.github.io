...
echo "${2}" | gpg --batch --yes --pinentry-mode=loopback --passphrase-fd 0 -abs -u E3FBADCD653604F37356F44571EF044FBD59EFC6 -o Release.gpg Release
echo "${2}" | gpg --batch --yes --pinentry-mode=loopback --passphrase-fd 0 --clearsign -u E3FBADCD653604F37356F44571EF044FBD59EFC6 -o InRelease Release
